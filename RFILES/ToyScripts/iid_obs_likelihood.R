#################################################################################
#
#  -file = "iid_obs_likelihood_AR.R"   Code written July 2014
...
#   source("iid_obs_likelihood_AR.R")
#
################################################################################
...
{ 
  ...
  ##---------------------------- STOP ---------------------------------------##
  #Set the likelihood for iid observations
  llik.y  = sum(dnorm(resid.y, sd=sqrt(sigma.y^2), log=TRUE)) #IID observations
  ##-------------------------------------------------------------------------##
