#################################################################################
#
#  -file = "VR_obs_likelihood_AR.R"   Code written July 2014
...
{ 
  ...
  model.out = VR_SL_model(par, hist.temp) # run the SLR model and name to output y.mod
  y.mod = model.out$sle
