#################################################################################
#
#  -file = "Toy_MCMC_HETER_AR1.R"   Code written February 2015
...
#       -Workspace file: "test_het_data.RData"
#
...
source("ToyScripts/toy.R")
source("ToyScripts/hetero_obs_likelihood_AR.R")
...
xlab="Forcast probability [%] (credible interval)", lwd=2, ylim=c(0,100))
