#################################################################################
#
#  -file = "KnownRho_homo_obs_likelihood_AR.R"   Code written July 2014
...
{ 
  ...
  rho.y = known.rho   # rho1 is the lag-1 autocorrelation coefficient estimate with the best-fit model realization
