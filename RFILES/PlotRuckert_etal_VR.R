...
ylab="Probability Density", xlim=c(min(heter.pdfa$x),max(heter.pdfa$x)), yaxt="n")
...
# lines(c(0.02,0.02),c(0,0.8), lwd=3, lty=2)
# lines(c(0,0.02),c(0.8,0.8), lwd=3, lty=2)
put.fig.letter("a.",font=2)
...
#T_0
plot(boot.pdfT0, lwd=3, col=test.colors[1], main="",xlab=expression(paste(T[0], " [", degree,"C] (base temperature)")),
ylab="Probability Density", xlim=c(-3,2), yaxt="n")
lines(homo.pdfT_0, lwd=3, col=test.colors[2])
lines(heter.pdfT_0, lwd=3, col=test.colors[3])
...
plot(boot.pdfinitialval, lwd=3, col=test.colors[1], main="",xlab=expression(paste(H[0], " [m] (initial value of sea-level)")),
ylab="Probability Density", xlim=c(-0.173, -0.125), yaxt="n")
...
# b
plot(homo.pdfb, lwd=3, col=test.colors[2], main="",xlab=expression(paste("b [m/", degree,"C] (Rapid response constant)")),
ylab="Probability Density", yaxt="n", xlim=c(-0.1,0.1))
lines(boot.pdfb, lwd=3, col=test.colors[1])
lines(heter.pdfb, lwd=3, col=test.colors[3])
# lines(c(-1,-1),c(0,0.5), lwd=3, lty=2)
# lines(c(1,1),c(0,0.5), lwd=3, lty=2)
# lines(c(-1,1),c(0.5,0.5), lwd=3, lty=2)
put.fig.letter("d.",font=2)
