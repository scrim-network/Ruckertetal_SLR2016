...
#       This script produces supplementary figure 4 in Ruckert et al. (accepted). For further description and
...
legend("topleft", c('99% CI Bootstrap','99% CI Homoskedastic Bayesian','99% CI Heteroskedastic Bayesian'), cex=0.85,
...
legend("topright", c('Bootstrap','Homoskedastic Bayesian','Heteroskedastic Bayesian'), cex=0.85,
pch=15, bty="n",col=trans_con_colors[1:3])
put.fig.letter("a. RCP8.5",font=2,  x=0.15, y=0.98)
